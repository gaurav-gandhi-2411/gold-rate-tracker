...
needs_model = pytest.mark.skipif(
    not _MODEL_READY, reason="ONNX model not trained or onnxruntime absent"
)
...
class TestNBeatsInferOnnx:
    ...
    def test_returns_scalar_for_batch1(self):
        from ml.nbeats_infer import LOOKBACK, load_nbeats_session
...
class TestPredictNbeatsDelta:
    ...
    def test_returns_none_for_short_history(self):
        from ml.nbeats_infer import LOOKBACK, load_nbeats_session, predict_nbeats_delta
