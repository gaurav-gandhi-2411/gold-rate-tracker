...
def test_release_queued_returns_and_clears(monkeypatch):
    # Freeze datetime.now so the 12-hour cutoff doesn't depend on wall-clock date.
    # queued_at is 2026-05-19 23:30 IST; freeze "now" to 1h later (00:30 IST May 20)
    # so the entry is well within the 12-hour window.
