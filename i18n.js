...
const STRINGS = {
  en: {
    ...
    sparklineRangeEstimate: ({ min, max }) => `Our IBJA-based estimate · Low ₹${min} · High ₹${max}`,
  ...
  hi: {
    ...
    sparklineRangeEstimate: ({ min, max }) => `IBJA पर आधारित हमारा अनुमान · न्यूनतम ₹${min} · अधिकतम ₹${max}`,
