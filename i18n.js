...
const STRINGS = {
  en: {
    ...
    pwaHelpPanelText: 'iOS limits how often home-screen apps update in the background. Tap <strong>↻</strong> to get the latest prices. If prices remain stuck, open the App Switcher (swipe up, hold), swipe this app away, and reopen from Home Screen — that forces a full reload.',
  ...
  hi: {
    ...
    pwaHelpPanelText: 'iOS होम-स्क्रीन ऐप्स को बैकग्राउंड में कम बार अपडेट करता है। ताज़ी कीमत के लिए <strong>↻</strong> दबाएं। अगर कीमत अटकी रहे, तो ऐप स्विचर खोलें (ऊपर स्वाइप करें, दबाए रखें), इस ऐप को स्वाइप करके हटाएं, और होम स्क्रीन से दोबारा खोलें — इससे पूरा रीलोड हो जाएगा।',
    ...
    rangeToggleAriaLabel: "चार्ट का समय दायरा",
    rangeAll: "सभी",
    ...
    // ── Verdict (computeVerdict) ────────────────────────────────────────────────
    verdictHeadlineUnknown: "अभी पर्याप्त डेटा नहीं है",
    ...
    cmpNotEnoughData: "पर्याप्त डेटा नहीं",
    cmpAtLow: "न्यूनतम पर",
    ...
    // ── Hero ──────────────────────────────────────────────────────────────────────
    heroEstimatedRange: ({ low, high }) => `अनुमानित दायरा ₹${low}–₹${high}`,
    ...
    methNextDayRangeHeading: "अगले कारोबारी दिन का दायरा",
    ...
    methNextDayExplainer: 'यह सिर्फ़ अगली रीडिंग के लिए है, कई दिन आगे के लिए नहीं — पिछले 30 टेस्ट रन में अगली रीडिंग तक कीमत आमतौर पर कितनी बदली, उस पर आधारित है। (ऊपर वाला "5 दिनों में करीब ±₹X" वाला नोट एक अलग, लंबी अवधि का अनुमान है।)',
    ...
    methAccurateP2: "यह रेंज सिर्फ़ कल की कीमत के बारे में है, कई दिन आगे की नहीं। यह सिर्फ़ पिछले 30 टेस्ट रन पर आधारित है, तो यह एक छोटा सैंपल है। जुलाई 2026 में हमने इस रेंज को छोटा किया, यह पता चलने के बाद कि यह 5-दिन के बदलाव के हिसाब से बनाई गई थी लेकिन हमेशा अगले-दिन की कीमतों के हिसाब से जांची जाती थी — इसलिए ऊपर दिया गया प्रतिशत कुछ समय तक असल से बेहतर दिख सकता है, जब तक कि सही, छोटी रेंज के तहत काफ़ी जांच न हो जाए। जब यह स्थिर हो जाएगा, तब हम इसे पूरी तरह सही मानेंगे।",
