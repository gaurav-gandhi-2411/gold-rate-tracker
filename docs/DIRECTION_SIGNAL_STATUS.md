...
|---|---|---|---|
| h=1 | <!--METRIC:data/direction_baseline.json#horizons.h1.n_test_folds:int-->161<!--/METRIC--> | <!--METRIC:data/direction_baseline.json#horizons.h1.trailing_30_fold_up_fraction:pct1-->83.3%<!--/METRIC--> | <!--METRIC:data/direction_baseline.json#horizons.h1.majority_class_collapse:raw-->False<!--/METRIC--> |
