...
|---|---|---|
| Can any model call tomorrow's direction? | **No, at either timeframe tested.** Next day: <!--METRIC:data/direction_baseline.json#horizons.h1.logistic_metrics.accuracy:pct1|n=horizons.h1.n_test_folds|asof=generated_at_utc-->48.5% (n=163, as of 2026-09-23)<!--/METRIC--> right vs. <!--METRIC:data/direction_baseline.json#horizons.h1.logistic_metrics.always_up_accuracy:pct1-->50.9%<!--/METRIC--> for "always guess up" (worse than guessing). Two days out: <!--METRIC:data/direction_baseline.json#horizons.h2.logistic_metrics.accuracy:pct1|n=horizons.h2.n_test_folds|asof=generated_at_utc-->61.5% (n=161, as of 2026-09-23)<!--/METRIC--> vs. <!--METRIC:data/direction_baseline.json#horizons.h2.logistic_metrics.always_up_accuracy:pct1-->59.0%<!--/METRIC--> — better-looking, but not statistically significant (p=<!--METRIC:data/direction_baseline.json#horizons.h2.logistic_metrics.p_value:num2-->0.45<!--/METRIC-->). Neither is shown. | [`docs/DIRECTION_SIGNAL_STATUS.md`](docs/DIRECTION_SIGNAL_STATUS.md) |
