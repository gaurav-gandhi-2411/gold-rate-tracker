...
| Can any model call tomorrow's direction? | **No, at either horizon we test.** h=1: <!--METRIC:data/direction_baseline.json#horizons.h1.logistic_metrics.accuracy:pct1|n=horizons.h1.n_test_folds|asof=generated_at_utc-->49.7% (n=147, as of 2026-08-28)<!--/METRIC--> accuracy vs. a <!--METRIC:data/direction_baseline.json#horizons.h1.logistic_metrics.always_up_accuracy:pct1-->51.7%<!--/METRIC--> base rate (worse than guessing "up"). h=2: <!--METRIC:data/direction_baseline.json#horizons.h2.logistic_metrics.accuracy:pct1|n=horizons.h2.n_test_folds|asof=generated_at_utc-->62.8% (n=145, as of 2026-08-28)<!--/METRIC--> vs. a <!--METRIC:data/direction_baseline.json#horizons.h2.logistic_metrics.always_up_accuracy:pct1-->60.0%<!--/METRIC--> base rate — better-looking, but not statistically significant (p=<!--METRIC:data/direction_baseline.json#horizons.h2.logistic_metrics.p_value:num2-->0.45<!--/METRIC-->). Neither ships. | [`docs/DIRECTION_SIGNAL_STATUS.md`](docs/DIRECTION_SIGNAL_STATUS.md), auto-updated weekly |
